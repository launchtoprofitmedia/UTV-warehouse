    ...
    _createClass(DesktopNavigation, [
      ...
      },
      {
        ...
        value: function _deactivateDropdown(event, target) {
          ...
          var menuToClose = target.querySelector('[data-type="menu"]');
              ...
              mutationList.forEach(function (mutation) {
                if (mutation.target.getAttribute("aria-hidden") === "false") {
                  ...
                  mutation.target.style.setProperty(
                    "--distance-to-top",
                    "".concat(
                      mutation.target.getBoundingClientRect().top,
                      "px",
                    ),
                  );
                }
      ...
      },
      {
        ...
        value: function _updateSelectors(newVariant) {
          ...
          if (this.variantSelectors && this.variantSelectors[0]) {
            ...
            this.productOptionsWithValues[0]["values"].forEach(
              function (value, valueIndex) {
                ...
                if (_this2.variantSelectors[1]) {
                  _this2.productOptionsWithValues[1]["values"].forEach(
                    function (value, valueIndex) {
                      applyClassToSelector(
                        ...
                        _this2.productOptionsWithValues[2]["values"].forEach(
                          function (value, valueIndex) {
                            applyClassToSelector(
                              ...
                              valueIndex,
                              _this2.productData["variants"].some(
                                function (variant) {
                                  return (
        ...
        value: function _updateAddToCartButton(newVariant) {
          ...
          if (!newVariant) {
            ...
            if (newVariant["available"]) {
              ...
              addToCartButtonElement.innerHTML =
                this.productTemplate === "pre-order"
  ...
  */
    ...
    _createClass(ProductGallery, [
      ...
      },
      {
        ...
        value: function variantHasChanged(newVariant) {
          ...
          fastdom.mutate(function () {
            _this2.productGalleryCellsElements.forEach(
              function (cell, imageIndex) {
                if (cell.hasAttribute("data-group-name")) {
                  ...
                  _this2.options["productOptions"].forEach(
          ...
          try {
            ...
            return fetch(sectionUrl, {
              ...
              response.text().then(function (content) {
                ...
                var desktopFilters = _this4.element.querySelector(
                    "#desktop-filters-form",
                  ),
                  mobileFilters = _this4.element.querySelector(
                ...
                var countJson = JSON.parse(
                  tempElement.querySelector("[data-collection-products-count]")
                    .innerHTML,
                );

                var showingProductsCount = _this4.element.querySelector(
                ...
                ).innerHTML = countJson["productsCount"]; // Finally, we scroll to the element
      ...
      },
      {
        ...
        value: function _loadContentResults() {
          ...
          fetch(
            ...
            response.text().then(function (content) {
              var linkSearchResults = _this5.element.querySelector(
                  ".link-search-results",
                ),
          ...
          if (currentInput === "") {
            ...
            Promise.all(queries).then(function (responses) {
              ...
              Promise.all(
                ...
                _this2.searchBarElement.querySelector(
  ...
  var ProductRecommendations = /*#__PURE__*/ (function (_HTMLElement) {
    ...
    function ProductRecommendations() {
      ...
      _this.delegateElement.on(
        "click",
        '[data-action="add-to-cart"]',
        _this._addToCart.bind(_assertThisInitialized(_this)),
      );
            ...
            response.text().then(function (text) {
              ...
              if (productRecommendationsElement.childElementCount > 0) {
                _this2.replaceChildren.apply(
                  _this2,
                  _toConsumableArray(
                    document.importNode(productRecommendationsElement, true)
                      .childNodes,
                  ),
                ); // Create Flickity slider

                _this2.flickityInstance = new flickityFade(
                  _this2.querySelector(".complementary-product-list"),
                  {
                    pageDots: false,
                    watchCSS: true,
                    groupCells: 2,
